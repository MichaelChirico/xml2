...
- [`xml_attr()`](http://xml2.r-lib.org/reference/xml_attr.md),
  ...
  [`xml_path()`](http://xml2.r-lib.org/reference/xml_path.md),
  [`xml_text()`](http://xml2.r-lib.org/reference/xml_text.md), and
  [`xml_type()`](http://xml2.r-lib.org/reference/xml_type.md) no longer
  use S3 dispatch but instead dispatch in C, leading to considerable
  performance improvements in many cases
  ([@mgirlich](https://github.com/mgirlich),
...
- [`xml_find_all.xml_nodeset()`](http://xml2.r-lib.org/reference/xml_find_all.md)
...
- [`write_xml()`](http://xml2.r-lib.org/reference/write_xml.md) and
  [`write_html()`](http://xml2.r-lib.org/reference/write_xml.md) now
...
- [`read_html()`](http://xml2.r-lib.org/reference/read_xml.md) and
  [`read_xml()`](http://xml2.r-lib.org/reference/read_xml.md) now error
  if passed strings of length greater than one
  ([\#121](https://github.com/r-lib/xml2/issues/121))

- [`read_xml.raw()`](http://xml2.r-lib.org/reference/read_xml.md) had an
  inadvertent regression in 1.3.0 and is now again fixed
...
- [`read_html()`](http://xml2.r-lib.org/reference/read_xml.md) now again
  works with HTML files with non-ASCII encodings
...
- print methods now match the type of document,
  e.g. [`read_html()`](http://xml2.r-lib.org/reference/read_xml.md)
...
- [`read_xml()`](http://xml2.r-lib.org/reference/read_xml.md) now has a
  better error message when given zero length character inputs
  ([\#212](https://github.com/r-lib/xml2/issues/212)).

- [`read_xml()`](http://xml2.r-lib.org/reference/read_xml.md) and
  [`read_html()`](http://xml2.r-lib.org/reference/read_xml.md) now
...
- [`xml_root()`](http://xml2.r-lib.org/reference/xml_children.md) can
  now create root nodes with namespaces
  ([\#239](https://github.com/r-lib/xml2/issues/239))

- [`xml_set_attr()`](http://xml2.r-lib.org/reference/xml_attr.md) no
...
- [`xml_set_attr()`](http://xml2.r-lib.org/reference/xml_attr.md) now
  recycles the values if needed
...
- [`as_list()`](http://xml2.r-lib.org/reference/as_list.md) on
  ...
  [`as_list()`](http://xml2.r-lib.org/reference/as_list.md).
...
- [`xml_attr()`](http://xml2.r-lib.org/reference/xml_attr.md) can now
  set attributes with no value
...
- Add
  [`xml_validate()`](http://xml2.r-lib.org/reference/xml_validate.md) to
...
- [`xml_cdata()`](http://xml2.r-lib.org/reference/xml_cdata.md) allows
  you to add CDATA nodes to a document.
  ([\#128](https://github.com/r-lib/xml2/issues/128))

- Add [`xml_set_text()`](http://xml2.r-lib.org/reference/xml_text.md)
  and [`xml_set_name()`](http://xml2.r-lib.org/reference/xml_name.md)
  equivalent to `xml_text<-` and `xml_name<-`.
  ([\#130](https://github.com/r-lib/xml2/issues/130)).

- Add [`xml_set_attr()`](http://xml2.r-lib.org/reference/xml_attr.md)
  and [`xml_set_attrs()`](http://xml2.r-lib.org/reference/xml_attr.md)
  equivalent to `xml_attr<-` and `xml_attrs<-`.
  ([\#109](https://github.com/r-lib/xml2/issues/109),
  [\#130](https://github.com/r-lib/xml2/issues/130))

- Add [`write_html()`](http://xml2.r-lib.org/reference/write_xml.md)
...
- [`as_list()`](http://xml2.r-lib.org/reference/as_list.md) now
...
- [`xml_integer()`](http://xml2.r-lib.org/reference/xml_text.md) and
  [`xml_double()`](http://xml2.r-lib.org/reference/xml_text.md)
...
- xml2 now supports modification and creation of XML nodes. New
  ...
  [`xml_root()`](http://xml2.r-lib.org/reference/xml_children.md) and
  replacement methods for
  [`xml_name()`](http://xml2.r-lib.org/reference/xml_name.md),
  [`xml_attr()`](http://xml2.r-lib.org/reference/xml_attr.md),
  [`xml_attrs()`](http://xml2.r-lib.org/reference/xml_attr.md) and
...
- [`xml_ns()`](http://xml2.r-lib.org/reference/xml_ns.md) now keeps
...
- [`read_xml()`](http://xml2.r-lib.org/reference/read_xml.md) and
  [`read_html()`](http://xml2.r-lib.org/reference/read_xml.md) methods
  added for
...
- [`xml_find_one()`](http://xml2.r-lib.org/reference/xml_find_all.md)
...
- [`xml_name()`](http://xml2.r-lib.org/reference/xml_name.md) and
  [`xml_text()`](http://xml2.r-lib.org/reference/xml_text.md) always
...
- Add [`xml_length()`](http://xml2.r-lib.org/reference/xml_children.md)
